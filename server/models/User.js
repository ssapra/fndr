...
module.exports = {
    ...
    twitterStrategy: function() {
        ...
        return new TwitterStrategy({
            ...
            callbackURL: process.env.TWITTER_CALLBACK_URL || 'http://localhost:9000/auth/twitter/callback'
        },
    ...
    facebookStrategy: function() {
        ...
        return new FacebookStrategy({
            ...
            callbackURL: process.env.FACEBOOK_CALLBACK_URL || "http://localhost:9000/auth/facebook/callback"
        },
    ...
    googleStrategy: function() {
        ...
        return new GoogleStrategy({
            returnURL: process.env.GOOGLE_RETURN_URL || "http://localhost:9000/auth/google/return",
            realm: process.env.GOOGLE_REALM || "http://localhost:9000/"
        },
    ...
    linkedInStrategy: function() {
        if(!process.env.FD_LINKED_IN_KEY)     throw new Error('A LinkedIn App Key is required if you want to enable login via LinkedIn.');
        if(!process.env.FD_LINKED_IN_SECRET) throw new Error('A LinkedIn App Secret is required if you want to enable login via LinkedIn.');

        return new LinkedInStrategy({
            consumerKey: process.env.FD_LINKED_IN_KEY,
            consumerSecret: process.env.FD_LINKED_IN_SECRET,
